...
class RouletteTexts:
    ...
    TACTICAL_ITEM_DROPS: Dict[TacticalItemType, List[str]] = {
        ...
        TacticalItemType.FLASHBANG: [
            "⚡ 嗡——！机器人反手扔出一枚【强光闪光弹】：‘看我白给一击！’全场瞬间白屏，@{user} 被闪瞎了狗眼，闪避率归零！",
    ...
    TALENT_TRIGGER_TEXTS: Dict[str, List[str]] = {
        ...
        "bluff_king": [
            "🗣️ 咔哒！本是一记空弹，但 @{user} 突然发出凄厉惨叫扑倒在地，三秒后又拍拍屁股爬起来：“我装的！吓到了吧哈哈哈哈！”",
            "🗣️ 虚张声势！@{user} 演得比奥斯卡影帝还真，成功把后排选手吓出一身冷汗！",
            "🗣️ 心理战大师！@{user} 扣出空枪却故意倒地装死，把全场观众秀了一脸！"
        ]
    }
